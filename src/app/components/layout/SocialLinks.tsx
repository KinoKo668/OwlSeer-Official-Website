...
const instagramLogoPath = "M224.1 141c-63.6 0-114.9 51.3-114.9 114.9s51.3 114.9 114.9 114.9S339 319.5 339 255.9 287.7 141 224.1 141zm0 189.6c-41.3 0-74.7-33.4-74.7-74.7s33.4-74.7 74.7-74.7 74.7 33.4 74.7 74.7-33.4 74.7-74.7 74.7zm146.4-194.3c0 14.9-12 26.9-26.9 26.9-14.9 0-26.9-12-26.9-26.9 0-14.9 12-26.9 26.9-26.9 14.9 0 26.9 12 26.9 26.9zm76.1 27.2c-1.7-35.3-9.7-66.6-35.5-92.4S354.1 1.7 318.8 0C282.4-2 173.6-2 137.2 0 101.9 1.7 70.6 9.7 44.8 35.5 19 61.3 11 92.6 9.3 127.9 7.3 164.3 7.3 273.1 9.3 309.5c1.7 35.3 9.7 66.6 35.5 92.4 25.8 25.8 57.1 33.8 92.4 35.5 36.4 2 145.2 2 181.6 0 35.3-1.7 66.6-9.7 92.4-35.5 25.8-25.8 33.8-57.1 35.5-92.4 2-36.4 2-145.2 0-181.6zM398.8 388c-7.7 19.3-22.6 34.2-41.9 41.9-29 11.5-97.8 8.8-132.8 8.8s-103.9 2.7-132.8-8.8c-19.3-7.7-34.2-22.6-41.9-41.9-11.5-29-8.8-97.8-8.8-132.8s-2.7-103.9 8.8-132.8c7.7-19.3 22.6-34.2 41.9-41.9 29-11.5 97.8-8.8 132.8-8.8s103.9-2.7 132.8 8.8c19.3 7.7 34.2 22.6 41.9 41.9 11.5 29 8.8 97.8 8.8 132.8s2.7 103.9-8.8 132.8z";
...
export function SocialLinks({ className = "flex items-center gap-5" }: SocialLinksProps) {
  ...
  return (
    <div className={className}>
      <a href="https://www.tiktok.com/@owlseerai" className={baseLinkClassName} aria-label="TikTok" {...externalProps}>
      ...
      <a href="https://x.com/owlseer_ai" className={baseLinkClassName} aria-label="X" {...externalProps}>
        <span className="sr-only">X</span>𝕏
      </a>

      <a href="https://www.instagram.com/owlseerai/" className={baseLinkClassName} aria-label="Instagram" {...externalProps}>
      ...
      <a href="https://t.me/owlseerai" className="transition-opacity hover:opacity-90" aria-label="Telegram" {...externalProps}>
      ...
      <a href="https://www.linkedin.com/company/owlseer/" className={baseLinkClassName} aria-label="LinkedIn" {...externalProps}>
      ...
      <a href="https://discord.gg/HRE4Q7RGS7" className={baseLinkClassName} aria-label="Discord" {...externalProps}>
        <span className="sr-only">Discord</span>
        <svg viewBox="0 0 640 512" className="h-[20px] w-[20px]" fill="currentColor" aria-hidden="true">
